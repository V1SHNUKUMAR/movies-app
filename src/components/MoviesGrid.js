...
const MoviesGrid = (props) => {
  ...
  return !isLoadingForMoviesGrid ? (
    <div className="grid grid-cols-2 gap-4 sm:gap-4 sm:grid-cols-3 lg:grid-cols-4 md:pt-2 lg:place-items-center">
  ...
  return (
    <Link to="/movie-details-page" onClick={() => handleClick(movie)}>
      <div
        ...
        className="lg:w-[195px] xl:w-[230px] min-h-[180px] xs:min-h-[250px] h-full rounded-2xl relative p-2 md:p-3 flex justify-between flex-col gap-10 xs:gap-20 md:gap-32"
      >
